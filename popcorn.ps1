...
if ($args -eq "help"){
    ...
    Write-Output ""
    Write-Output "You MUST fill in the 'libraryRoot', 'tmdbApiKey' and 'googleApiKey' information at" | woAnnouncement
    write-output "MINIMUM for Popcorn to work.  The other settings are optional or situational." | woAnnouncement
    Write-Output ""
